...
select job
  ...
  case 'define' then
    ...
    x.graphics.in_style=['shape=triangle;strokeColor=blue;fillColor=blue';'shape=triangle;strokeColor=blue;fillColor=blue';'shape=triangle;strokeColor=blue;fillColor=blue'];
