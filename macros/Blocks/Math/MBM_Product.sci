...
function [x,y,typ]=MBM_Product(job,arg1,arg2)
x=[];y=[];typ=[];
select job
  case 'plot' then
  ...
  case 'define' then
    ...
    model.out=[1];
    mo=modelica();
      mo.model='Modelica.Blocks.Math.Product';
      mo.inputs=['u1','u2'];
      mo.outputs=['y'];
    ...
    gr_i=[
          ...
          'e.thickness=0.25;';
          'e.line_style=1;';
          'xpoly(xx+ww*[0.425;0.575],yy+hh*[0.62995;0.37005]);';
          'e=gce();';
          'e.visible=""on"";';
          'e.foreground=color(0,0,0);';
          'e.thickness=0.25;';
    ...
    x.graphics.in_style=['shape=triangle;strokeColor=blue;shape=triangle;fillColor=blue';'shape=triangle;strokeColor=blue;fillColor=blue'];
