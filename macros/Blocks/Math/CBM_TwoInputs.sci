...
select job
  case 'plot' then
    standard_draw(arg1,%f,_CBI_TwoInputs_dp);
  case 'getinputs' then
    [x,y,typ]=_CBI_TwoInputs_ip(arg1);
  case 'getoutputs' then
    [x,y,typ]=_CBI_TwoInputs_op(arg1);
  case 'getorigin' then
  ...
  case 'define' then
    ...
    gr_i=[
          ...
          'e.fill_mode=""off"";';
          'if orient then';
          '  xstringb(orig(1)+sz(1)*0.025,orig(2)+sz(2)*0.25,""="",sz(1)*0.95,sz(2)*0.5,""fill"");';
          'else';
          '  xstringb(orig(1)+sz(1)*(1-0.025-0.95),orig(2)+sz(2)*0.25,""="",sz(1)*0.95,sz(2)*0.5,""fill"");';
          'end';
          'e=gce();';
          'e.visible=""on"";';
          'e.foreground=color(0,0,0);';
          'e.background=color(0,0,191);';
          'e.font_foreground=color(0,0,191);';
          'e.fill_mode=""off"";'
         ];
