...
function [x,y,typ]=MBM_Division(job,arg1,arg2)
x=[];y=[];typ=[];
select job
  case 'plot' then
  ...
  case 'define' then
    ...
    model.out=[1];
    mo=modelica();
      mo.model='Modelica.Blocks.Math.Division';
      mo.inputs=['u1','u2'];
      mo.outputs=['y'];
    ...
    gr_i=[
          ...
          'e.thickness=0.25;';
          'e.line_style=1;';
          'xpoly(xx+ww*[0.35;0.65],yy+hh*[0.5;0.5]);';
          'e=gce();';
          'e.visible=""on"";';
          'e.foreground=color(0,0,0);';
          'e.thickness=0.25;';
          'e.line_style=1;';
          'if orient then';
          '  xarc(orig(1)+sz(1)*0.475,orig(2)+sz(2)*0.65,sz(1)*0.05,sz(2)*0.05,0,360*64);';
          'else';
          '  xarc(orig(1)+sz(1)*(1-0.475-0.05),orig(2)+sz(2)*0.65,sz(1)*0.05,sz(2)*0.05,0,360*64);';
          'end';
          'e=gce();';
          'e.visible=""on"";';
          'e.foreground=color(0,0,0);';
          ...
          'e.line_style=1;';
          'if orient then';
          '  xarc(orig(1)+sz(1)*0.475,orig(2)+sz(2)*0.4,sz(1)*0.05,sz(2)*0.05,0,360*64);';
          'else';
          '  xarc(orig(1)+sz(1)*(1-0.475-0.05),orig(2)+sz(2)*0.4,sz(1)*0.05,sz(2)*0.05,0,360*64);';
          'end';
          'e=gce();';
          'e.visible=""on"";';
          'e.foreground=color(0,0,0);';
          ...
          'e.font_foreground=color(0,0,255);';
          'e.fill_mode=""off"";';
          'xpoly(xx+ww*[0;0.17;0.3],yy+hh*[0.8;0.8;0.65]);';
          'e=gce();';
          'e.visible=""on"";';
          'e.foreground=color(0,0,191);';
          'e.thickness=0.25;';
          'e.line_style=1;';
          'xpoly(xx+ww*[0;0.5;0.5],yy+hh*[0.2;0.2;0.25]);';
          'e=gce();';
          'e.visible=""on"";';
          'e.foreground=color(0,0,191);';
          'e.thickness=0.25;';
    ...
    x.graphics.in_style=['strokeColor=blue;fillColor=blue';'strokeColor=blue;fillColor=blue'];
