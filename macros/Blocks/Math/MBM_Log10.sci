...
function [x,y,typ]=MBM_Log10(job,arg1,arg2)
x=[];y=[];typ=[];
select job
  case 'plot' then
  ...
  case 'define' then
    ...
    model.out=[1];
    mo=modelica();
      mo.model='Modelica.Blocks.Math.Log10';
      mo.inputs=['u'];
      mo.outputs=['y'];
    ...
    gr_i=[
          ...
          'e.thickness=0.25;';
          'e.line_style=1;';
          'xpoly(xx+ww*[0.101;0.104;0.108;0.112;0.116;0.124;0.136;0.1525;0.1765;0.2125;0.265;0.341;0.4495;0.6105;0.8435;0.9],yy+hh*[0.1;0.247;0.315;0.36;0.3935;0.443;0.49345;0.5404;0.5895;0.64;0.6905;0.7405;0.79;0.84;0.8905;0.9]);';
          'e=gce();';
          'e.visible=""on"";';
          'e.foreground=color(0,0,0);';
          'e.thickness=0.25;';
          ...
          'e.line_style=1;';
          'if orient then';
          '  xstringb(orig(1)+sz(1)*0.35,orig(2)+sz(2)*0.15,""log10"",sz(1)*0.45,sz(2)*0.24,""fill"");';
          'else';
          '  xstringb(orig(1)+sz(1)*(1-0.35-0.45),orig(2)+sz(2)*0.15,""log10"",sz(1)*0.45,sz(2)*0.24,""fill"");';
          'end';
          'e=gce();';
          'e.visible=""on"";';
          'e.foreground=color(0,0,0);';
