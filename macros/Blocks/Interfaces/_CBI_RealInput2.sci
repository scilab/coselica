...
function [x,y,typ]=CBI_RealInput2(job,arg1,arg2)
x=[];y=[];typ=[];
select job
  case 'plot' then
  ...
  case 'define' then
    ...
    model.dep_ut=[%t %f];
    mo=modelica();
      mo.model='Coselica.Blocks.Interfaces.RealInput2';
      mo.inputs=['u'];
      mo.outputs=['y'];
    ...
    gr_i=[...
          ...
          'e.line_style=1;';...
          'if orient then';...
          '  xstringb(orig(1)+sz(1)*-0.25,orig(2)+sz(2)*0.4,""2"",sz(1)*1.125,sz(2)*0.2,""fill"");';...
          'else';...
          '  xstringb(orig(1)+sz(1)*(1--0.25-1.125),orig(2)+sz(2)*0.4,""2"",sz(1)*1.125,sz(2)*0.2,""fill"");';...
          'end';...
          'e=gce();';...
          'e.visible=""on"";';...
          'e.foreground=color(0,0,0);';...
          'e.background=color(255,255,255);';...
          'e.font_foreground=color(255,255,255);';...
          'e.fill_mode=""off"";';...
          'if orient then';...
