  ...
  case 'set' then
    ...
    while %t do
      [ok,height,duration,offset,startTime,exprs]=...
        scicos_getvalue(['';'MBS_Ramp';'';'Generate ramp signal';''],...
        [' height [-] : Height of ramps';' duration [-] : Durations of ramp';' offset [-] : Offset of output signal';' startTime [s] : Output = offset for time < startTime'],...
