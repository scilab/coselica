...
select job
  ...
  case 'set' then
    ...
    while %t do
      [ok,amplitude,rising,width,falling,period,nperiod,offset,startTime,exprs]=...
        getvalue(['';'CBS_Trapezoid';'';'Generate trapezoidal signal of type Real';''],...
  ...
  case 'define' then
    ...
    offset=0;
    startTime=0;
    model.sim='CBS_Trapezoid';
    model.blocktype='c';
    model.dep_ut=[%t %f];
    mo=modelica();
      mo.model='CBS_Trapezoid';
      mo.inputs=[];
      mo.outputs=['y'];
    ...
    exprs=[sci2exp(amplitude); sci2exp(rising); sci2exp(width); ...
           sci2exp(falling); sci2exp(period); sci2exp(nperiod); ...
    ...
    gr_i=[...
          ...
          'e.fill_mode=""off"";';...
          'xpoly(xx+ww*[0.095;0.2;0.35;0.545;0.695;0.805;0.95],yy+hh*[0.15;0.15;0.7;0.7;0.15;0.15;0.7]);';...
          'e=gce();';...
          'e.visible=""on"";';...
          'e.foreground=color(0,0,0);';...
          'e.thickness=0.25;';...
