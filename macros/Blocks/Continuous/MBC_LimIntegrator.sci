...
select job
  case 'plot' then
    ...
    outMax=arg1.graphics.exprs(2);
    outMin=arg1.graphics.exprs(3);
  ...
  case 'define' then
    ...
    gr_i=[
          ...
          'e.thickness=0.25;';
          'e.line_style=1;';
          'xpoly(xx+ww*[0.1;0.6;0.9],yy+hh*[0.1;0.6;0.6]);';
          'e=gce();';
          'e.visible=""on"";';
          ...
          'e.line_style=1;';
          'if orient then';
          '  xstringb(orig(1)+sz(1)*0.5,orig(2)+sz(2)*0.15,""I"",sz(1)*0.3,sz(2)*0.3,""fill"");';
          'else';
          '  xstringb(orig(1)+sz(1)*(1-0.5-0.3),orig(2)+sz(2)*0.15,""I"",sz(1)*0.3,sz(2)*0.3,""fill"");';
          'end';
          'e=gce();';
          'e.visible=""on"";';
          'e.foreground=color(0,0,0);';
