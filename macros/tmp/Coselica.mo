package XcosModelica
  ...
  package Thermal
    ...
    package HeatTransfer
      ...
      model TemperatureSensor "Absolute temperature sensor in Kelvin"
        XcosModelica.Blocks.Interfaces.RealOutput T;
      ...
      model RelTemperatureSensor "Relative Temperature sensor"
        extends XcosModelica.Icons.TranslationalSensor;
        Interfaces.HeatPort_a port_a;
        Interfaces.HeatPort_b port_b;
        XcosModelica.Blocks.Interfaces.RealOutput T_rel;
      equation
      ...
      model PrescribedTemperature "Variable temperature boundary condition in Kelvin"
        ...
        XcosModelica.Blocks.Interfaces.RealInput T;
      equation
        port.T = T.signal;
      ...
      model PrescribedHeatFlow "Prescribed heat flow boundary condition"
        ...
        Interfaces.HeatPort_b port;
        XcosModelica.Blocks.Interfaces.RealInput Q_flow;
      equation
      ...
      model HeatFlowSensor "Heat flow rate sensor"
        extends XcosModelica.Icons.RotationalSensor;
        Interfaces.HeatPort_a port_a;
        Interfaces.HeatPort_b port_b;
        XcosModelica.Blocks.Interfaces.RealOutput Q_flow "Heat flow from port_a to port_b";
      equation
        port_a.T = port_b.T;
      ...
      model Convection "Lumped thermal element for heat convection"
        ...
        XcosModelica.Blocks.Interfaces.RealInput Gc "Signal representing the convective thermal conductance in [W/K]";
      equation
        dT = solid.T - fluid.T;
        solid.Q_flow = Q_flow;
        fluid.Q_flow =  -Q_flow;
      ...
      package Celsius
        ...
        model ToKelvin "Conversion model from °Celsius to Kelvin.signal"
          XcosModelica.Blocks.Interfaces.RealInput Celsius;
          XcosModelica.Blocks.Interfaces.RealOutput Kelvin;
        equation
        ...
        model FromKelvin "Conversion from Kelvin.signal to °Celsius"
          XcosModelica.Blocks.Interfaces.RealInput Kelvin;
          XcosModelica.Blocks.Interfaces.RealOutput Celsius;
        equation
      ...
      equation
        Q_flow = Gr * XcosModelica.Constants.sigma * (port_a.T ^ 4 - port_b.T ^ 4);
      end BodyRadiation;
  ...
  package Mechanics
    ...
    package Translational
      ...
      model Force "External force acting on a drive train element as input signal"
        ...
        XcosModelica.Blocks.Interfaces.RealInput f "driving force as input signal";
      equation
        flange_b.f =  -f.signal;
      end Force;
      ...
      model Accelerate "Forced movement of a.signal flange according to an acceleration signal"
        ...
        XcosModelica.Blocks.Interfaces.RealInput a "absolute acceleration of flange as input signal";
        Interfaces.Flange_b flange_b;
      equation
        s = flange_b.s;
        v = der(s);
    ...
    package Rotational
      ...
      model TorqueStep "Constant torque, not dependent on speed"
        extends XcosModelica.Mechanics.Rotational.Interfaces.PartialSpeedDependentTorque;
      ...
      model Torque "Input signal acting as external torque on a flange"
        XcosModelica.Blocks.Interfaces.RealInput tau "Torque driving the flange ";
      ...
      model Torque2 "Input signal acting as torque on two flanges"
        ...
        XcosModelica.Blocks.Interfaces.RealInput tau "Torque driving the two flanges ";
      equation
      ...
      package Sensors
        ...
        model TorqueSensor "Ideal sensor to measure the torque between two flanges (= flange_a.tau)"
          ...
          Interfaces.Flange_b flange_b;
          XcosModelica.Blocks.Interfaces.RealOutput tau "Torque in flange flange_a and flange_b (= flange_a.tau = -flange_b.tau)";
        equation
        ...
        model SpeedSensor "Ideal sensor to measure the absolute flange angular velocity"
          ...
          XcosModelica.Blocks.Interfaces.RealOutput w "Absolute angular velocity of flange";
        equation
        ...
        model RelSpeedSensor "Ideal sensor to measure the relative angular velocity between two flanges"
          ...
          XcosModelica.Blocks.Interfaces.RealOutput w_rel "Relative angular velocity between two flanges (= der(flange_b.phi) - der(flange_a.phi)";
        equation
        ...
        model RelAngleSensor "Ideal sensor to measure the relative angle between two flanges"
          ...
          Interfaces.Flange_a flange_a "driving flange (flange axis directed INTO cut plane)";
          Interfaces.Flange_b flange_b "(right) driven flange (flange axis directed OUT OF cut plane)";
          XcosModelica.Blocks.Interfaces.RealOutput phi_rel "Relative angle between two flanges (= flange_b.phi - flange_a.phi)";
        equation
        ...
        model RelAccSensor "Ideal sensor to measure the relative angular acceleration between two flanges"
          ...
          XcosModelica.Blocks.Interfaces.RealOutput a_rel "Relative angular acceleration between two flanges";
        equation
          phi_rel = flange_b.phi - flange_a.phi;
          w_rel = der(phi_rel);
        ...
        model AngleSensor "Ideal sensor to measure the absolute flange angle"
          extends XcosModelica.Icons.RotationalSensor;
          Interfaces.Flange_a flange_a "flange to be measured";
          XcosModelica.Blocks.Interfaces.RealOutput phi "Absolute angle of flange";
        equation
        ...
        model AccSensor "Ideal sensor to measure the absolute flange angular acceleration"
          ...
          XcosModelica.Blocks.Interfaces.RealOutput a "Absolute angular acceleration of flange";
        equation
          w = der(flange_a.phi);
          a.signal = der(w);
          0 = flange_a.tau;
      ...
      package Interfaces
        ...
        partial model PartialSpeedDependentTorque "Partial model of a torque acting at the flange (accelerates the flange)"
          ...
          XcosModelica.Mechanics.Rotational.Interfaces.Flange_b flange "Flange on which torque is acting";
          XcosModelica.Mechanics.Rotational.Interfaces.Flange_a bearing "Bearing at which the reaction torque (i.e., -flange.tau) is acting";
        equation
          if false then
            bearing.phi = 0;
          else
      ...
      model IdealGearR2T "Gearbox transforming rotational into translational motion"
        ...
        Real f_support;
        Interfaces.Flange_a flange_a;
        XcosModelica.Mechanics.Translational.Interfaces.Flange_b flange_b;
    ...
    package Analog
      ...
      package Sources
        ...
        model StepVoltage "Step voltage source"
          ...
          XcosModelica.Blocks.Sources.Step signalSource(final offset = offset, final startTime = startTime, height = V);
        equation
        ...
        model StepCurrent "Step current source"
          ...
          XcosModelica.Blocks.Sources.Step signalSource(final offset = offset, final startTime = startTime, height = I);
        equation
        ...
        model SineVoltage "Sine voltage source"
          ...
          extends Interfaces.VoltageSource;
          XcosModelica.Blocks.Sources.Sine signalSource(final offset = offset, final startTime = startTime, amplitude = V, freqHz = freqHz, phase = phase);
        equation
          v = signalSource.y.signal;
        end SineVoltage;
        ...
        model SineCurrent "Sine current source"
          ...
          parameter Real freqHz = 1 "Frequency of sine wave";
          extends Interfaces.CurrentSource;
          XcosModelica.Blocks.Sources.Sine signalSource(final offset = offset, final startTime = startTime, amplitude = I, freqHz = freqHz, phase = phase);
        equation
          i = signalSource.y.signal;
        end SineCurrent;
        ...
        model SignalVoltage "Generic voltage source using the input signal as source voltage"
          ...
          XcosModelica.Blocks.Interfaces.RealInput v "Voltage between pin p and n  as input signal";
        ...
        model SignalCurrent "Generic current source using the input signal as source current"
          ...
          XcosModelica.Blocks.Interfaces.RealInput i "Current flowing from pin p to pin n as input signal";
        equation
          v = p.v - n.v;
          0 = p.i + n.i;
          i.signal = p.i;
        ...
        model SawToothVoltage "Saw tooth voltage source"
          ...
          extends Interfaces.VoltageSource;
          XcosModelica.Blocks.Sources.SawTooth signalSource(final offset = offset, final startTime = startTime, amplitude = V, period = period);
        equation
          v = signalSource.y.signal;
        end SawToothVoltage;
        ...
        model SawToothCurrent "Saw tooth current source"
          ...
          parameter Real period = 1 "Time for one period";
          extends Interfaces.CurrentSource;
          XcosModelica.Blocks.Sources.SawTooth signalSource(final offset = offset, final startTime = startTime, amplitude = I, period = period);
        equation
          i = signalSource.y.signal;
        end SawToothCurrent;
        ...
        model RampVoltage "Ramp voltage source"
          ...
          extends Interfaces.VoltageSource;
          XcosModelica.Blocks.Sources.Ramp signalSource(final offset = offset, final startTime = startTime, height = V, duration = duration);
        equation
          v = signalSource.y.signal;
        end RampVoltage;
        ...
        model RampCurrent "Ramp current source"
          ...
          parameter Real duration = 2 "Duration of ramp";
          extends Interfaces.CurrentSource;
          XcosModelica.Blocks.Sources.Ramp signalSource(final offset = offset, final startTime = startTime, height = I, duration = duration);
        equation
          i = signalSource.y.signal;
        end RampCurrent;
        ...
        model PulseVoltage "Pulse voltage source"
          ...
          parameter Real period = 1 "Time for one period";
          extends Interfaces.VoltageSource;
          XcosModelica.Blocks.Sources.Pulse signalSource(final offset = offset, final startTime = startTime, amplitude = V, width = width, period = period);
        equation
          v = signalSource.y.signal;
        end PulseVoltage;
        ...
        model PulseCurrent "Pulse current source"
          ...
          parameter Real period = 1 "Time for one period";
          extends Interfaces.CurrentSource;
          XcosModelica.Blocks.Sources.Pulse signalSource(final offset = offset, final startTime = startTime, amplitude = I, width = width, period = period);
        equation
          i = signalSource.y.signal;
        end PulseCurrent;
      ...
      package Sensors
        ...
        model VoltageSensor "Sensor to measure the voltage between two pins"
          ...
          XcosModelica.Blocks.Interfaces.RealOutput v "Voltage between pin p and n (= p.v - n.v) as output signal";
        equation
          p.i = 0;
          n.i = 0;
          v.signal = p.v - n.v;
        ...
        model PotentialSensor "Sensor to measure the potential"
          ...
          XcosModelica.Blocks.Interfaces.RealOutput phi "Absolute voltage potential as output signal";
        equation
          p.i = 0;
          phi.signal = p.v;
        end PotentialSensor;
        ...
        model CurrentSensor "Sensor to measure the current in a branch"
          ...
          Interfaces.PositivePin p "positive pin";
          Interfaces.NegativePin n "negative pin";
          XcosModelica.Blocks.Interfaces.RealOutput i "current in the branch from p to n as output signal";
        equation
          p.v = n.v;
          p.i = i.signal;
          n.i =  -i.signal;
      ...
      package Semiconductors
        ...
        public
          XcosModelica.Electrical.Analog.Interfaces.Pin C "Collector";
          XcosModelica.Electrical.Analog.Interfaces.Pin B "Base";
          XcosModelica.Electrical.Analog.Interfaces.Pin E "Emitter";
        equation
          ExMin = exp(EMin);
          ExMax = exp(EMax);
          vbc = C.v - B.v;
        ...
        model Diode "Simple diode"
          extends XcosModelica.Electrical.Analog.Interfaces.OnePort;
      ...
      package Ideal
        ...
        model IdealOpeningSwitch "Ideal electrical opener"
          ...
          XcosModelica.Blocks.Interfaces.RealInput control "true => switch open, false => p--n connected";
        protected
        ...
        model IdealClosingSwitch "Ideal electrical closer"
          ...
          parameter Real Ron = 1e-05 "Closed switch resistance";
          parameter Real Goff = 1e-05 "Opened switch conductance";
          XcosModelica.Blocks.Interfaces.RealInput control "true => p--n connected, false => switch open";
        protected
          Real s "Auxiliary variable";
        equation
      ...
      package Basic
        ...
        model VariableResistor "Ideal linear electrical resistor with variable resistance"
          extends XcosModelica.Electrical.Analog.Interfaces.OnePort;
          XcosModelica.Blocks.Interfaces.RealInput R;
        equation
          v = R.signal * i;
        ...
        model VariableInductor "Ideal linear electrical inductor with variable inductance"
          extends XcosModelica.Electrical.Analog.Interfaces.OnePort;
          XcosModelica.Blocks.Interfaces.RealInput L;
          Real Psi;
          parameter Real Lmin = XcosModelica.Constants.eps;
        equation
        ...
        model VariableCapacitor "Ideal linear electrical capacitor with variable capacitance"
          extends XcosModelica.Electrical.Analog.Interfaces.OnePort;
          XcosModelica.Blocks.Interfaces.RealInput C;
          parameter Real Cmin = XcosModelica.Constants.eps;
          Real Q;
        equation
        ...
        model OpAmp "Simple nonideal model of an OpAmp with limitation"
          ...
          XcosModelica.Electrical.Analog.Interfaces.PositivePin in_p "Positive pin of the input port";
          XcosModelica.Electrical.Analog.Interfaces.NegativePin in_n "Negative pin of the input port";
          XcosModelica.Electrical.Analog.Interfaces.PositivePin out "Output pin";
          XcosModelica.Electrical.Analog.Interfaces.PositivePin VMax "Positive output voltage limitation";
          XcosModelica.Electrical.Analog.Interfaces.NegativePin VMin "Negative output voltage limitation";
        ...
        model HeatingResistor "Temperature dependent electrical resistor"
          ...
          XcosModelica.Thermal.HeatTransfer.Interfaces.HeatPort_a heatPort;
        equation
          v = R * i;
          if true then
        ...
        model EMF "Electromotoric force (electric/mechanic transformer)"
          ...
          Interfaces.PositivePin p;
          Interfaces.NegativePin n;
          XcosModelica.Mechanics.Rotational.Interfaces.Flange_b flange_b;
        equation
          v = p.v - n.v;
          0 = p.i + n.i;
          i = p.i;
  ...
  package Blocks
    ...
    package Sources
      ...
      protected
        constant Real pi = XcosModelica.Constants.pi;
      equation
      ...
      model Pulse "Generate pulse signal of type Real"
        ...
        parameter Real offset = 0 "Offset of output signals";
        parameter Real startTime = 0 "Output = offset for time < startTime";
        extends XcosModelica.Blocks.Interfaces.SO;
      protected
        Real T0(final start = startTime) "Start time of current period";
    ...
    package Continuous
      ...
      model PID "PID-controller in additive description form"
        ...
        Blocks.Continuous.Derivative D(k = Td, T = max(Td / Nd,100 * XcosModelica.Constants.eps)) "Derivative part of PID controller";
      ...
      model Derivative "Approximated derivative block"
        ...
        Real x "State of block";
      equation
        der(x) = if noEvent(abs(k) >= XcosModelica.Constants.eps) then (u.signal - x) / T else 0;
        y.signal = if noEvent(abs(k) >= XcosModelica.Constants.eps) then k / T * (u.signal - x) else 0;
      end Derivative;
...
package XcosCoselica
  ...
  package Mechanics
    ...
    package Translational
      ...
      equation
        when s > smax - L / 2 then
            reinit(s, smax - L / 2 - XcosModelica.Constants.eps);
        ...
        when s < smin + L / 2 then
            reinit(s, smin + L / 2 + XcosModelica.Constants.eps);
          reinit(v, if v < 0 then 0 else v);
      ...
      public
        XcosModelica.Mechanics.Translational.Interfaces.Flange_b flange_b;
        XcosModelica.Blocks.Interfaces.RealInput v_ref "reference velocity of flange as input signal";
      equation
      ...
      package Sensors
        ...
        model SpeedSensor "Ideal sensor to measure the absolute velocity"
          extends XcosCoselica.Mechanics.Translational.Interfaces.PartialAbsoluteSensor;
          XcosModelica.Blocks.Interfaces.RealOutput v "Absolute velocity of flange as output signal";
        equation
          v.signal = der(flange.s);
        end SpeedSensor;

        model RelSpeedSensor "Ideal sensor to measure the relative speed"
          extends XcosCoselica.Mechanics.Translational.Interfaces.PartialRelativeSensor;
          Real s_rel "distance between the two flanges (flange_b.s - flange_a.s)";
          XcosModelica.Blocks.Interfaces.RealOutput v_rel "Relative velocity between two flanges  - der(flange_a.s)";
        equation
          s_rel = flange_b.s - flange_a.s;
        ...
        model RelPositionSensor "Ideal sensor to measure the relative position"
          extends XcosCoselica.Mechanics.Translational.Interfaces.PartialRelativeSensor;
          XcosModelica.Blocks.Interfaces.RealOutput s_rel "Distance between two flanges ";
        equation
        ...
        model RelAccSensor "Ideal sensor to measure the relative acceleration"
          ...
          XcosModelica.Blocks.Interfaces.RealOutput a_rel "Relative acceleration between two flanges ";
        equation
          s_rel = flange_b.s - flange_a.s;
          v_rel = der(s_rel);
        ...
        model PowerSensor "Ideal sensor to measure the power.signal between two flanges (= flange_a.f*der(flange_a.s))"
          extends XcosCoselica.Mechanics.Translational.Interfaces.PartialRelativeSensor;
          XcosModelica.Blocks.Interfaces.RealOutput power "Power in flange flange_a";
        equation
        ...
        model PositionSensor "Ideal sensor to measure the absolute position"
          extends XcosCoselica.Mechanics.Translational.Interfaces.PartialAbsoluteSensor;
          XcosModelica.Blocks.Interfaces.RealOutput s "Absolute position of flange";
        equation
          s.signal = flange.s;
        end PositionSensor;
        ...
        model ForceSensor "Ideal sensor to measure the force between two flanges"
          extends XcosCoselica.Mechanics.Translational.Interfaces.PartialRelativeSensor;
          XcosModelica.Blocks.Interfaces.RealOutput f "force in flange_a and flange_b ";
        equation
          flange_a.s = flange_b.s;
          flange_a.f = f.signal;
        end ForceSensor;
        ...
        model AccSensor "Ideal sensor to measure the absolute acceleration"
          ...
          XcosModelica.Blocks.Interfaces.RealOutput a "Absolute acceleration of flange as output signal";
        equation
          v = der(flange.s);
          a.signal = der(v);
        end AccSensor;
      ...
      public
        XcosModelica.Mechanics.Translational.Interfaces.Flange_b flange_b;
        XcosModelica.Blocks.Interfaces.RealInput s_ref "reference position of flange as input signal";
      equation
        s = flange_b.s;
        s = s_ref.signal;
      end Position;
      ...
      package Interfaces
        ...
        partial model PartialTwoFlanges "Component with two translational 1D flanges "
          XcosModelica.Mechanics.Translational.Interfaces.Flange_a flange_a "(left) driving flange (flange axis directed in to cut plane, e. g. from left to right)";
          XcosModelica.Mechanics.Translational.Interfaces.Flange_b flange_b "(right) driven flange (flange axis directed out of cut plane)";
        ...
        partial model PartialCompliantWithRelativeStates "Base model for the compliant connection of two translational 1-dim. shaft flanges where the relative position and relative velocities are used as states"
          ...
          XcosModelica.Mechanics.Translational.Interfaces.Flange_a flange_a "Left flange of compliant 1-dim. translational component";
          XcosModelica.Mechanics.Translational.Interfaces.Flange_b flange_b "Right flange of compliant 1-dim. transational component";
        equation
          s_rel = flange_b.s - flange_a.s;
          v_rel = der(s_rel);
          flange_b.f = f;
        ...
        partial model PartialAbsoluteSensor "Device to measure a single absolute flange variable"
          extends XcosModelica.Icons.TranslationalSensor;
          XcosModelica.Mechanics.Translational.Interfaces.Flange_a flange "flange to be measured (flange axis directed in to cut plane, e. g. from left to right)";
        equation
          0 = flange.f;
        end PartialAbsoluteSensor;

        partial model FrictionBase "Base class of Coulomb friction elements"
          extends XcosModelica.Mechanics.Translational.Interfaces.Rigid;
      ...
      package Components
        ...
        model ElastoGap "1D translational spring damper combination with gap"
          extends XcosCoselica.Mechanics.Translational.Interfaces.PartialCompliantWithRelativeStates;
    ...
    package Rotational
      ...
      public
        XcosModelica.Mechanics.Rotational.Interfaces.Flange_b flange_b;
        XcosModelica.Blocks.Interfaces.RealInput w_ref "Reference angular velocity of flange_b as input signal";
        XcosModelica.Mechanics.Rotational.Interfaces.Flange_a bearing;
      equation
        0 = flange_b.tau + tau_support;
        bearing.tau = tau_support;
      ...
      package Sensors
        ...
        model PowerSensor "Ideal sensor to measure the power.signal between two flanges (= flange_a.tau*der(flange_a.phi))"
          extends XcosModelica.Icons.RotationalSensor;
          XcosModelica.Mechanics.Rotational.Interfaces.Flange_a flange_a;
          XcosModelica.Mechanics.Rotational.Interfaces.Flange_b flange_b;
          XcosModelica.Blocks.Interfaces.RealOutput power "Power in flange flange_a";
        equation
          flange_a.phi = flange_b.phi;
      ...
      model Position "Forced movement of a flange according to a reference angle signal"
        XcosModelica.Blocks.Interfaces.RealInput phi_ref "reference angle of flange_b as input signal";
        Real phi "absolute rotation angle of flange flange_b";
        Real tau_support "Support torque";
      public
        XcosModelica.Mechanics.Rotational.Interfaces.Flange_b flange_b;
      ...
      model OneWayClutch "Series connection of freewheel and clutch"
        extends XcosModelica.Mechanics.Rotational.Interfaces.Compliant;
      ...
      public
        XcosModelica.Blocks.Interfaces.RealInput f_normalized "Normalized force signal 0..1 ";
      equation
        mue0 = mue_pos;
      ...
      package Interfaces
        ...
        partial model PartialCompliantWithRelativeStates "Partial model for the compliant connection of two rotational 1-dim. shaft flanges where the relative angle and speed are used as preferred states"
          ...
          Real tau "Torque between flanges (= flange_b.tau)";
          XcosModelica.Mechanics.Rotational.Interfaces.Flange_a flange_a "Left flange of compliant 1-dim. rotational component";
          XcosModelica.Mechanics.Rotational.Interfaces.Flange_b flange_b "Right flange of compliant 1-dim. rotational component";
        equation
          phi_rel = flange_b.phi - flange_a.phi;
          w_rel = der(phi_rel);
          a_rel = der(w_rel);
        ...
        partial model FrictionBaseBearing "Base class of Coulomb friction elements"
          extends XcosModelica.Mechanics.Rotational.Interfaces.TwoFlangesAndBearing;
          parameter Real mode_start = 0 "Initial sliding mode (-1=Backward,0=Sticking,1=Forward,2=Free)";
          Real w_relfric "Relative angular velocity between frictional surfaces";
          Real a_relfric "Relative angular acceleration between frictional surfaces";
      ...
      package Components
        ...
        model ElastoBacklash "Backlash connected in series to linear spring and damper (backlash is modeled with elasticity)"
          ...
          parameter Real phi_rel0 = 0 "Unstretched spring angle";
          extends XcosCoselica.Mechanics.Rotational.Interfaces.PartialCompliantWithRelativeStates(tau(start = tau_c + tau_d, fixed = true));
        protected
        ...
        model Disc "1-dim. rotational rigid component without inertia, where right flange is rotated by a fixed angle with respect to left flange"
          extends XcosModelica.Mechanics.Rotational.Interfaces.TwoFlanges;
    ...
    package Planar
      ...
      package Sensors
        ...
        model RelAngularVelocity "Measure relative angular velocity (= frame_b.w - frame_a.w)"
          ...
          XcosModelica.Blocks.Interfaces.RealOutput w_rel "Relative angular velocity ";
        equation
          frame_a.f = {0,0};
          frame_b.f = {0,0};
          frame_a.t = 0;
        ...
        model RelAngularAcceleration "Measure relative angular acceleration (= frame_b.z - frame_a.z)"
          ...
          Interfaces.Frame_a frame_a "Coordinate system with one cut-force and cut-torque";
          Interfaces.Frame_b frame_b "Coordinate system with one cut-force and cut-torque";
          XcosModelica.Blocks.Interfaces.RealOutput z_rel "Relative angular acceleration ";
        equation
          frame_a.f = {0,0};
          frame_b.f = {0,0};
          frame_a.t = 0;
        ...
        model Power "Measure power.signal flowing from frame_a to frame_b"
          ...
          Interfaces.Frame_a frame_a "Coordinate system with one cut-force and cut-torque";
          Interfaces.Frame_b frame_b "Coordinate system with one cut-force and cut-torque";
          XcosModelica.Blocks.Interfaces.RealOutput power "Power at frame_a as output signal";
        equation
        ...
        model Distance "Measure the distance.signal between the origins of two frame connectors"
          ...
          Interfaces.Frame_a frame_a "Coordinate system with one cut-force and cut-torque";
          Interfaces.Frame_b frame_b "Coordinate system with one cut-force and cut-torque";
          XcosModelica.Blocks.Interfaces.RealOutput distance "Distance between the origin of frame_a and the origin of frame_b";
        ...
        model CutTorque "Measure cut torque.signal (= frame_a.t)"
          ...
          XcosModelica.Blocks.Interfaces.RealOutput torque "Cut torque resolved in frame_a/frame_b";
        equation
          frame_b.r_0 = frame_a.r_0;
          frame_b.v_0 = frame_a.v_0;
          frame_b.a_0 = frame_a.a_0;
        ...
        model CutForce "Measure cut force.signal (= frame_a.f) resolved in world frame"
          ...
          XcosModelica.Blocks.Interfaces.RealOutput force[2] "Cut force  resolved in world frame";
        equation
          frame_b.r_0 = frame_a.r_0;
          frame_b.v_0 = frame_a.v_0;
          frame_b.a_0 = frame_a.a_0;
        ...
        model CutForce2 "Measure cut force.signal (= frame_a.f) resolved in frame_resolve"
          ...
          XcosModelica.Blocks.Interfaces.RealOutput force[2] "Cut force  resolved in frame_resolve";
        protected
        ...
        model Angle "Measure angle.signal to rotate frame_a into frame_b (= frame_b.phi - frame_a.phi)"
          ...
          Interfaces.Frame_a frame_a "Coordinate system with one cut-force and cut-torque";
          Interfaces.Frame_b frame_b "Coordinate system with one cut-force and cut-torque";
          XcosModelica.Blocks.Interfaces.RealOutput angle "Angle to rotate frame_a into frame_b ";
        equation
          frame_a.f = {0,0};
          frame_b.f = {0,0};
          frame_a.t = 0;
      ...
      package LoopJoints
        ...
        model ActuatedRevolute "Actuated revolute joint used in loops (1 rotational degree-of-freedom, no states)"
          ...
          XcosModelica.Mechanics.Rotational.Interfaces.Flange_a axis "1-dim. rotational flange that drives the joint";
          XcosModelica.Mechanics.Rotational.Interfaces.Flange_b bearing "1-dim. rotational flange of the drive bearing";
        equation
          axis.phi = phi;
          bearing.phi = 0;
        ...
        model ActuatedPrismatic "Actuated prismatic joint used in loops (1 translational degree-of-freedom, no states)"
          ...
          XcosModelica.Mechanics.Translational.Interfaces.Flange_a axis "1-dim. translational flange that drives the joint";
          XcosModelica.Mechanics.Translational.Interfaces.Flange_b bearing "1-dim. translational flange of the drive bearing";
        equation
          axis.s = s;
          bearing.s = 0;
      ...
      package Interfaces
        ...
        partial model PartialRelativeVectorSensor "Base model to measure a relative vector variable between two frames"
          ...
          XcosModelica.Blocks.Interfaces.RealOutput y[2] "Measured data as signal vector";
        equation
          frame_a.f = {0,0};
          frame_a.t = 0;
          frame_b.f = {0,0};
        ...
        partial model PartialAbsoluteSensor "Base model to measure a absolute frame variable"
          extends XcosModelica.Icons.RotationalSensor;
          Interfaces.Frame_a frame_a "Coordinate system a";
          XcosModelica.Blocks.Interfaces.RealOutput y "Measured data as signal vector";
        equation
          frame_a.f = {0,0};
          frame_a.t = 0;
        end PartialAbsoluteSensor;
      ...
      package Forces
        ...
        model WorldTorque "External torce acting at frame_b"
          ...
          XcosModelica.Blocks.Interfaces.RealInput torque "Torque signal";
        equation
          frame_b.f = {0,0};
        ...
        model WorldForce "External force.signal acting at frame_b, defined by 2 input signals and resolved in world frame"
          ...
          XcosModelica.Blocks.Interfaces.RealInput force[2] "x- and y-coordinates of force resolved in world frame";
        equation
        ...
        model LineForce "General line force component"
          extends Interfaces.PartialTwoFrames;
          XcosModelica.Mechanics.Translational.Interfaces.Flange_a flange_b "1-dim. translational flange (connect force of Translational library between flange_a and flange_b)";
          XcosModelica.Mechanics.Translational.Interfaces.Flange_b flange_a "1-dim. translational flange (connect force of Translational library between flange_a and flange_b)";
  ...
  package Blocks
    ...
    package Routing
      ...
      model Multiplex2 "Multiplexer model for two input connectors"
        extends XcosModelica.Blocks.Interfaces.BlockIcon;
        XcosModelica.Blocks.Interfaces.RealInput u1 "Connector of Real input signals 1";
        XcosModelica.Blocks.Interfaces.RealInput u2 "Connector of Real input signals 2";
        XcosModelica.Blocks.Interfaces.RealOutput y[2] "Connector of Real output signals";
      equation
      ...
      model DeMultiplex2 "DeMultiplexer model for two output connectors"
        extends XcosModelica.Blocks.Interfaces.BlockIcon;
        XcosModelica.Blocks.Interfaces.RealInput u[2] "Connector of Real input signals";
        XcosModelica.Blocks.Interfaces.RealOutput y1 "Connector of Real output signals 1";
        XcosModelica.Blocks.Interfaces.RealOutput y2 "Connector of Real output signals 2";
      equation
    ...
    package Math
      ...
      model TwoOutputs "Change causality of output signals by defining that two output signals are identical (e.g. for inverse models)"
        extends XcosModelica.Blocks.Interfaces.BlockIcon;
        XcosModelica.Blocks.Interfaces.RealOutput y1 "Connector of first Real output signal";
        XcosModelica.Blocks.Interfaces.RealOutput y2 "Connector of second Real output signal ";
      equation
        y1.signal = y2.signal;
      end TwoOutputs;
      ...
      model TwoInputs "Change causality of input signals by defining that two input signals are identical (e.g. for inverse models)"
        extends XcosModelica.Blocks.Interfaces.BlockIcon;
        XcosModelica.Blocks.Interfaces.RealInput u1 "Connector of first Real input signal";
        XcosModelica.Blocks.Interfaces.RealInput u2 "Connector of second Real input signal ";
      equation
        u1.signal = u2.signal;
      end TwoInputs;

      model Atan2 "Output atan(u1.signal/u2.signal) of the inputs u1.signal and u2.signal"
        extends XcosModelica.Blocks.Interfaces.SI2SO;
      equation
    ...
    package Interfaces
      ...
      model RealOutput
        XcosModelica.Blocks.Interfaces.RealInput u;
        Real y;
      equation
        y = u.signal;
      end RealOutput;
      ...
      model RealInput
        Real u;
        XcosModelica.Blocks.Interfaces.RealOutput y;
      equation
        y.signal = u;
      end RealInput;
...
model CBI_RealOutput
  extends XcosCoselica.Blocks.Interfaces.RealOutput;
end CBI_RealOutput;

model CBI_RealInput
  extends XcosCoselica.Blocks.Interfaces.RealInput;
end CBI_RealInput;

model CBR_Multiplex2
  extends XcosCoselica.Blocks.Routing.Multiplex2;
end CBR_Multiplex2;

model CBR_DeMultiplex2
  extends XcosCoselica.Blocks.Routing.DeMultiplex2;
end CBR_DeMultiplex2;

model MBM_Gain
  extends XcosModelica.Blocks.Math.Gain;
end MBM_Gain;

model MBM_Abs
  extends XcosModelica.Blocks.Math.Abs;
end MBM_Abs;

model MBM_Sign
  extends XcosModelica.Blocks.Math.Sign;
end MBM_Sign;

model MBM_Sqrt
  extends XcosModelica.Blocks.Math.Sqrt;
end MBM_Sqrt;

model MBM_Sin
  extends XcosModelica.Blocks.Math.Sin;
end MBM_Sin;

model MBM_Cos
  extends XcosModelica.Blocks.Math.Cos;
end MBM_Cos;

model MBM_Tan
  extends XcosModelica.Blocks.Math.Tan;
end MBM_Tan;

model MBM_Asin
  extends XcosModelica.Blocks.Math.Asin;
end MBM_Asin;

model MBM_Acos
  extends XcosModelica.Blocks.Math.Acos;
end MBM_Acos;

model MBM_Atan
  extends XcosModelica.Blocks.Math.Atan;
end MBM_Atan;

model MBM_Sinh
  extends XcosModelica.Blocks.Math.Sinh;
end MBM_Sinh;

model MBM_Cosh
  extends XcosModelica.Blocks.Math.Cosh;
end MBM_Cosh;

model MBM_Tanh
  extends XcosModelica.Blocks.Math.Tanh;
end MBM_Tanh;

model MBM_Exp
  extends XcosModelica.Blocks.Math.Exp;
end MBM_Exp;

model MBM_Log
  extends XcosModelica.Blocks.Math.Log;
end MBM_Log;

model MBM_Log10
  extends XcosModelica.Blocks.Math.Log10;
end MBM_Log10;

model MBM_Add
  extends XcosModelica.Blocks.Math.Add;
end MBM_Add;

model MBM_Product
  extends XcosModelica.Blocks.Math.Product;
end MBM_Product;

model MBM_Division
  extends XcosModelica.Blocks.Math.Division;
end MBM_Division;

model MBM_Max
  extends XcosModelica.Blocks.Math.Max;
end MBM_Max;

model MBM_Min
  extends XcosModelica.Blocks.Math.Min;
end MBM_Min;

model CBM_Atan2
  extends XcosCoselica.Blocks.Math.Atan2;
end CBM_Atan2;

model MBM_Feedback
  extends XcosModelica.Blocks.Math.Feedback;
end MBM_Feedback;

model CBM_TwoInputs
  extends XcosCoselica.Blocks.Math.TwoInputs;
end CBM_TwoInputs;

model CBM_TwoOutputs
  extends XcosCoselica.Blocks.Math.TwoOutputs;
end CBM_TwoOutputs;

model MBS_Clock
  extends XcosModelica.Blocks.Sources.Clock;
end MBS_Clock;

model MBS_Constant
  extends XcosModelica.Blocks.Sources.Constant;
end MBS_Constant;

model MBS_Step
  extends XcosModelica.Blocks.Sources.Step;
end MBS_Step;

model MBS_Ramp
  extends XcosModelica.Blocks.Sources.Ramp;
end MBS_Ramp;

model MBS_Sine
  extends XcosModelica.Blocks.Sources.Sine;
end MBS_Sine;

model MBS_ExpSine
  extends XcosModelica.Blocks.Sources.ExpSine;
end MBS_ExpSine;

model MBS_Exponentials
  extends XcosModelica.Blocks.Sources.Exponentials;
end MBS_Exponentials;

model MBS_Pulse
  extends XcosModelica.Blocks.Sources.Pulse;
end MBS_Pulse;

model MBS_SawTooth
  extends XcosModelica.Blocks.Sources.SawTooth;
end MBS_SawTooth;

model CBS_Trapezoid
  extends XcosCoselica.Blocks.Sources.Trapezoid;
end CBS_Trapezoid;

model MBC_Integrator
  extends XcosModelica.Blocks.Continuous.Integrator;
end MBC_Integrator;

model MBC_LimIntegrator
  extends XcosModelica.Blocks.Continuous.LimIntegrator;
end MBC_LimIntegrator;

model MBC_Der
  extends XcosModelica.Blocks.Continuous.Der;
end MBC_Der;

model MBC_Derivative
  extends XcosModelica.Blocks.Continuous.Derivative;
end MBC_Derivative;

model MBC_FirstOrder
  extends XcosModelica.Blocks.Continuous.FirstOrder;
end MBC_FirstOrder;

model MBC_SecondOrder
  extends XcosModelica.Blocks.Continuous.SecondOrder;
end MBC_SecondOrder;

model MBC_PI
  extends XcosModelica.Blocks.Continuous.PI;
end MBC_PI;

model MBC_PID
  extends XcosModelica.Blocks.Continuous.PID;
end MBC_PID;

model MBC_LimPID
  extends XcosModelica.Blocks.Continuous.LimPID;
end MBC_LimPID;

model MBN_Limiter
  extends XcosModelica.Blocks.Nonlinear.Limiter;
end MBN_Limiter;

model MBN_DeadZone
  extends XcosModelica.Blocks.Nonlinear.DeadZone;
end MBN_DeadZone;

model MEAB_Ground
  extends XcosModelica.Electrical.Analog.Basic.Ground;
end MEAB_Ground;

model MEAB_Resistor
  extends XcosModelica.Electrical.Analog.Basic.Resistor;
end MEAB_Resistor;

model MEAB_Capacitor
  extends XcosModelica.Electrical.Analog.Basic.Capacitor;
end MEAB_Capacitor;

model MEAB_Inductor
  extends XcosModelica.Electrical.Analog.Basic.Inductor;
end MEAB_Inductor;

model MEAB_EMF
  extends XcosModelica.Electrical.Analog.Basic.EMF;
end MEAB_EMF;

model MEAB_VariableResistor
  extends XcosModelica.Electrical.Analog.Basic.VariableResistor;
end MEAB_VariableResistor;

model MEAB_VariableCapacitor
  extends XcosModelica.Electrical.Analog.Basic.VariableCapacitor;
end MEAB_VariableCapacitor;

model MEAB_VariableInductor
  extends XcosModelica.Electrical.Analog.Basic.VariableInductor;
end MEAB_VariableInductor;

model MEAB_Transformer
  extends XcosModelica.Electrical.Analog.Basic.Transformer;
end MEAB_Transformer;

model MEAB_Gyrator
  extends XcosModelica.Electrical.Analog.Basic.Gyrator;
end MEAB_Gyrator;

model MEAB_VCV
  extends XcosModelica.Electrical.Analog.Basic.VCV;
end MEAB_VCV;

model MEAB_VCC
  extends XcosModelica.Electrical.Analog.Basic.VCC;
end MEAB_VCC;

model MEAB_CCV
  extends XcosModelica.Electrical.Analog.Basic.CCV;
end MEAB_CCV;

model MEAB_CCC
  extends XcosModelica.Electrical.Analog.Basic.CCC;
end MEAB_CCC;

model MEAB_OpAmp
  extends XcosModelica.Electrical.Analog.Basic.OpAmp;
end MEAB_OpAmp;

model MEAB_HeatingResistor
  extends XcosModelica.Electrical.Analog.Basic.HeatingResistor;
end MEAB_HeatingResistor;

model MEAS_PotentialSensor
  extends XcosModelica.Electrical.Analog.Sensors.PotentialSensor;
end MEAS_PotentialSensor;

model MEAS_VoltageSensor
  extends XcosModelica.Electrical.Analog.Sensors.VoltageSensor;
end MEAS_VoltageSensor;

model MEAS_CurrentSensor
  extends XcosModelica.Electrical.Analog.Sensors.CurrentSensor;
end MEAS_CurrentSensor;

model MEAS_ConstantVoltage
  extends XcosModelica.Electrical.Analog.Sources.ConstantVoltage;
end MEAS_ConstantVoltage;

model MEAS_SignalVoltage
  extends XcosModelica.Electrical.Analog.Sources.SignalVoltage;
end MEAS_SignalVoltage;

model MEAS_ConstantCurrent
  extends XcosModelica.Electrical.Analog.Sources.ConstantCurrent;
end MEAS_ConstantCurrent;

model MEAS_SignalCurrent
  extends XcosModelica.Electrical.Analog.Sources.SignalCurrent;
end MEAS_SignalCurrent;

model MEAS_StepVoltage
  extends XcosModelica.Electrical.Analog.Sources.StepVoltage;
end MEAS_StepVoltage;

model MEAS_StepCurrent
  extends XcosModelica.Electrical.Analog.Sources.StepCurrent;
end MEAS_StepCurrent;

model MEAS_SineVoltage
  extends XcosModelica.Electrical.Analog.Sources.SineVoltage;
end MEAS_SineVoltage;

model MEAS_SineCurrent
  extends XcosModelica.Electrical.Analog.Sources.SineCurrent;
end MEAS_SineCurrent;

model MEAS_PulseVoltage
  extends XcosModelica.Electrical.Analog.Sources.PulseVoltage;
end MEAS_PulseVoltage;

model MEAS_PulseCurrent
  extends XcosModelica.Electrical.Analog.Sources.PulseCurrent;
end MEAS_PulseCurrent;

model MEAS_RampVoltage
  extends XcosModelica.Electrical.Analog.Sources.RampVoltage;
end MEAS_RampVoltage;

model MEAS_RampCurrent
  extends XcosModelica.Electrical.Analog.Sources.RampCurrent;
end MEAS_RampCurrent;

model MEAS_SawToothVoltage
  extends XcosModelica.Electrical.Analog.Sources.SawToothVoltage;
end MEAS_SawToothVoltage;

model MEAS_SawToothCurrent
  extends XcosModelica.Electrical.Analog.Sources.SawToothCurrent;
end MEAS_SawToothCurrent;

model MEAI_Idle
  extends XcosModelica.Electrical.Analog.Ideal.Idle;
end MEAI_Idle;

model MEAI_Short
  extends XcosModelica.Electrical.Analog.Ideal.Short;
end MEAI_Short;

model MEAI_IdealOpeningSwitch
  extends XcosModelica.Electrical.Analog.Ideal.IdealOpeningSwitch;
end MEAI_IdealOpeningSwitch;

model MEAI_IdealClosingSwitch
  extends XcosModelica.Electrical.Analog.Ideal.IdealClosingSwitch;
end MEAI_IdealClosingSwitch;

model MEAI_IdealTransformer
  extends XcosModelica.Electrical.Analog.Ideal.IdealTransformer;
end MEAI_IdealTransformer;

model MEAI_IdealGyrator
  extends XcosModelica.Electrical.Analog.Ideal.IdealGyrator;
end MEAI_IdealGyrator;

model MEAS_Diode
  extends XcosModelica.Electrical.Analog.Semiconductors.Diode;
end MEAS_Diode;

model MEAS_NPN
  extends XcosModelica.Electrical.Analog.Semiconductors.NPN;
end MEAS_NPN;

model MEAS_PNP
  extends XcosModelica.Electrical.Analog.Semiconductors.PNP;
end MEAS_PNP;

model MEAS_NMOS
  extends XcosModelica.Electrical.Analog.Semiconductors.NMOS;
end MEAS_NMOS;

model MEAS_PMOS
  extends XcosModelica.Electrical.Analog.Semiconductors.PMOS;
end MEAS_PMOS;

model MMT_Fixed
  extends XcosModelica.Mechanics.Translational.Fixed;
end MMT_Fixed;

model MMT_Rod
  extends XcosModelica.Mechanics.Translational.Rod;
end MMT_Rod;

model MMT_Spring
  extends XcosModelica.Mechanics.Translational.Spring;
end MMT_Spring;

model MMT_Damper
  extends XcosModelica.Mechanics.Translational.Damper;
end MMT_Damper;

model MMT_SpringDamper
  extends XcosModelica.Mechanics.Translational.SpringDamper;
end MMT_SpringDamper;

model CMTC_ElastoGap
  extends XcosCoselica.Mechanics.Translational.Components.ElastoGap;
end CMTC_ElastoGap;

model CMT_Stop
  extends XcosCoselica.Mechanics.Translational.Stop;
end CMT_Stop;

model CMT_MassWithFriction
  extends XcosCoselica.Mechanics.Translational.MassWithFriction;
end CMT_MassWithFriction;

model MMT_SlidingMass
  extends XcosModelica.Mechanics.Translational.SlidingMass;
end MMT_SlidingMass;

model MMT_Force
  extends XcosModelica.Mechanics.Translational.Force;
end MMT_Force;

model CMTS_Force2
  extends XcosCoselica.Mechanics.Translational.Sources.Force2;
end CMTS_Force2;

model CMT_Position
  extends XcosCoselica.Mechanics.Translational.Position;
end CMT_Position;

model CMT_Speed
  extends XcosCoselica.Mechanics.Translational.Speed;
end CMT_Speed;

model MMT_Accelerate
  extends XcosModelica.Mechanics.Translational.Accelerate;
end MMT_Accelerate;

model CMTS_ForceSensor
  extends XcosCoselica.Mechanics.Translational.Sensors.ForceSensor;
end CMTS_ForceSensor;

model CMTS_PowerSensor
  extends XcosCoselica.Mechanics.Translational.Sensors.PowerSensor;
end CMTS_PowerSensor;

model CMTS_PositionSensor
  extends XcosCoselica.Mechanics.Translational.Sensors.PositionSensor;
end CMTS_PositionSensor;

model CMTS_SpeedSensor
  extends XcosCoselica.Mechanics.Translational.Sensors.SpeedSensor;
end CMTS_SpeedSensor;

model CMTS_AccSensor
  extends XcosCoselica.Mechanics.Translational.Sensors.AccSensor;
end CMTS_AccSensor;

model CMTS_RelPositionSensor
  extends XcosCoselica.Mechanics.Translational.Sensors.RelPositionSensor;
end CMTS_RelPositionSensor;

model CMTS_RelSpeedSensor
  extends XcosCoselica.Mechanics.Translational.Sensors.RelSpeedSensor;
end CMTS_RelSpeedSensor;

model CMTS_RelAccSensor
  extends XcosCoselica.Mechanics.Translational.Sensors.RelAccSensor;
end CMTS_RelAccSensor;

model MMR_Fixed
  extends XcosModelica.Mechanics.Rotational.Fixed;
end MMR_Fixed;

model CMRC_Disc
  extends XcosCoselica.Mechanics.Rotational.Components.Disc;
end CMRC_Disc;

model MMR_Inertia
  extends XcosModelica.Mechanics.Rotational.Inertia;
end MMR_Inertia;

model MMR_Spring
  extends XcosModelica.Mechanics.Rotational.Spring;
end MMR_Spring;

model MMR_Damper
  extends XcosModelica.Mechanics.Rotational.Damper;
end MMR_Damper;

model MMR_SpringDamper
  extends XcosModelica.Mechanics.Rotational.SpringDamper;
end MMR_SpringDamper;

model MMR_IdealGear
  extends XcosModelica.Mechanics.Rotational.IdealGear;
end MMR_IdealGear;

model MMR_ElastoBacklash
  extends XcosModelica.Mechanics.Rotational.ElastoBacklash;
end MMR_ElastoBacklash;

model CMRC_ElastoBacklash
  extends XcosCoselica.Mechanics.Rotational.Components.ElastoBacklash;
end CMRC_ElastoBacklash;

model MMR_IdealGearR2T
  extends XcosModelica.Mechanics.Rotational.IdealGearR2T;
end MMR_IdealGearR2T;

model MMR_IdealPlanetary
  extends XcosModelica.Mechanics.Rotational.IdealPlanetary;
end MMR_IdealPlanetary;

model CMR_BearingFriction
  extends XcosCoselica.Mechanics.Rotational.BearingFriction;
end CMR_BearingFriction;

model CMR_OneWayClutch
  extends XcosCoselica.Mechanics.Rotational.OneWayClutch;
end CMR_OneWayClutch;

model CMR_Clutch
  extends XcosCoselica.Mechanics.Rotational.Clutch;
end CMR_Clutch;

model CMR_Brake
  extends XcosCoselica.Mechanics.Rotational.Brake;
end CMR_Brake;

model CMR_Freewheel
  extends XcosCoselica.Mechanics.Rotational.Freewheel;
end CMR_Freewheel;

model MMRS_TorqueSensor
  extends XcosModelica.Mechanics.Rotational.Sensors.TorqueSensor;
end MMRS_TorqueSensor;

model CMRS_PowerSensor
  extends XcosCoselica.Mechanics.Rotational.Sensors.PowerSensor;
end CMRS_PowerSensor;

model MMRS_RelAngleSensor
  extends XcosModelica.Mechanics.Rotational.Sensors.RelAngleSensor;
end MMRS_RelAngleSensor;

model MMRS_RelSpeedSensor
  extends XcosModelica.Mechanics.Rotational.Sensors.RelSpeedSensor;
end MMRS_RelSpeedSensor;

model MMRS_RelAccSensor
  extends XcosModelica.Mechanics.Rotational.Sensors.RelAccSensor;
end MMRS_RelAccSensor;

model MMRS_AngleSensor
  extends XcosModelica.Mechanics.Rotational.Sensors.AngleSensor;
end MMRS_AngleSensor;

model MMRS_SpeedSensor
  extends XcosModelica.Mechanics.Rotational.Sensors.SpeedSensor;
end MMRS_SpeedSensor;

model MMRS_AccSensor
  extends XcosModelica.Mechanics.Rotational.Sensors.AccSensor;
end MMRS_AccSensor;

model MMR_Torque2
  extends XcosModelica.Mechanics.Rotational.Torque2;
end MMR_Torque2;

model MMR_Torque
  extends XcosModelica.Mechanics.Rotational.Torque;
end MMR_Torque;

model MMR_Accelerate
  extends XcosModelica.Mechanics.Rotational.Accelerate;
end MMR_Accelerate;

model CMR_Position
  extends XcosCoselica.Mechanics.Rotational.Position;
end CMR_Position;

model CMR_Speed
  extends XcosCoselica.Mechanics.Rotational.Speed;
end CMR_Speed;

model MMR_ConstantTorque
  extends XcosModelica.Mechanics.Rotational.ConstantTorque;
end MMR_ConstantTorque;

model MMR_ConstantSpeed
  extends XcosModelica.Mechanics.Rotational.ConstantSpeed;
end MMR_ConstantSpeed;

model MMR_TorqueStep
  extends XcosModelica.Mechanics.Rotational.TorqueStep;
end MMR_TorqueStep;

model MMR_LinearSpeedDependent
  extends XcosModelica.Mechanics.Rotational.LinearSpeedDependentTorque;
end MMR_LinearSpeedDependent;

model MMR_QuadraticSpeedDepend
  extends XcosModelica.Mechanics.Rotational.QuadraticSpeedDependentTorque;
end MMR_QuadraticSpeedDepend;

model CMP_World
  extends XcosCoselica.Mechanics.Planar.World;
end CMP_World;

model CMPP_FixedTranslation
  extends XcosCoselica.Mechanics.Planar.Parts.FixedTranslation;
end CMPP_FixedTranslation;

model CMPP_FixedRotation
  extends XcosCoselica.Mechanics.Planar.Parts.FixedRotation;
end CMPP_FixedRotation;

model CMPP_Body
  extends XcosCoselica.Mechanics.Planar.Parts.Body;
end CMPP_Body;

model CMPP_BodyShape
  extends XcosCoselica.Mechanics.Planar.Parts.BodyShape;
end CMPP_BodyShape;

model CMPJ_Revolute
  extends XcosCoselica.Mechanics.Planar.Joints.Revolute;
end CMPJ_Revolute;

model CMPJ_ActuatedRevolute
  extends XcosCoselica.Mechanics.Planar.Joints.ActuatedRevolute;
end CMPJ_ActuatedRevolute;

model CMPJ_Prismatic
  extends XcosCoselica.Mechanics.Planar.Joints.Prismatic;
end CMPJ_Prismatic;

model CMPJ_ActuatedPrismatic
  extends XcosCoselica.Mechanics.Planar.Joints.ActuatedPrismatic;
end CMPJ_ActuatedPrismatic;

model CMPJ_FreeMotion
  extends XcosCoselica.Mechanics.Planar.Joints.FreeMotion;
end CMPJ_FreeMotion;

model CMPL_Revolute
  extends XcosCoselica.Mechanics.Planar.LoopJoints.Revolute;
end CMPL_Revolute;

model CMPL_ActuatedRevolute
  extends XcosCoselica.Mechanics.Planar.LoopJoints.ActuatedRevolute;
end CMPL_ActuatedRevolute;

model CMPL_Prismatic
  extends XcosCoselica.Mechanics.Planar.LoopJoints.Prismatic;
end CMPL_Prismatic;

model CMPL_ActuatedPrismatic
  extends XcosCoselica.Mechanics.Planar.LoopJoints.ActuatedPrismatic;
end CMPL_ActuatedPrismatic;

model CMPS_CutTorque
  extends XcosCoselica.Mechanics.Planar.Sensors.CutTorque;
end CMPS_CutTorque;

model CMPS_CutForce
  extends XcosCoselica.Mechanics.Planar.Sensors.CutForce;
end CMPS_CutForce;

model CMPS_CutForce2
  extends XcosCoselica.Mechanics.Planar.Sensors.CutForce2;
end CMPS_CutForce2;

model CMPS_Distance
  extends XcosCoselica.Mechanics.Planar.Sensors.Distance;
end CMPS_Distance;

model CMPS_RelPosition
  extends XcosCoselica.Mechanics.Planar.Sensors.RelPosition;
end CMPS_RelPosition;

model CMPS_RelVelocity
  extends XcosCoselica.Mechanics.Planar.Sensors.RelVelocity;
end CMPS_RelVelocity;

model CMPS_RelAcceleration
  extends XcosCoselica.Mechanics.Planar.Sensors.RelAcceleration;
end CMPS_RelAcceleration;

model CMPS_RelPosition2
  extends XcosCoselica.Mechanics.Planar.Sensors.RelPosition2;
end CMPS_RelPosition2;

model CMPS_RelVelocity2
  extends XcosCoselica.Mechanics.Planar.Sensors.RelVelocity2;
end CMPS_RelVelocity2;

model CMPS_RelAcceleration2
  extends XcosCoselica.Mechanics.Planar.Sensors.RelAcceleration2;
end CMPS_RelAcceleration2;

model CMPS_AbsPosition
  extends XcosCoselica.Mechanics.Planar.Sensors.AbsPosition;
end CMPS_AbsPosition;

model CMPS_AbsVelocity
  extends XcosCoselica.Mechanics.Planar.Sensors.AbsVelocity;
end CMPS_AbsVelocity;

model CMPS_AbsAcceleration
  extends XcosCoselica.Mechanics.Planar.Sensors.AbsAcceleration;
end CMPS_AbsAcceleration;

model CMPS_AbsPosition2
  extends XcosCoselica.Mechanics.Planar.Sensors.AbsPosition2;
end CMPS_AbsPosition2;

model CMPS_AbsVelocity2
  extends XcosCoselica.Mechanics.Planar.Sensors.AbsVelocity2;
end CMPS_AbsVelocity2;

model CMPS_AbsAcceleration2
  extends XcosCoselica.Mechanics.Planar.Sensors.AbsAcceleration2;
end CMPS_AbsAcceleration2;

model CMPS_Angle
  extends XcosCoselica.Mechanics.Planar.Sensors.Angle;
end CMPS_Angle;

model CMPS_RelAngularVelocity
  extends XcosCoselica.Mechanics.Planar.Sensors.RelAngularVelocity;
end CMPS_RelAngularVelocity;

model CMPS_RelAngularAccelerat
  extends XcosCoselica.Mechanics.Planar.Sensors.RelAngularAcceleration;
end CMPS_RelAngularAccelerat;

model CMPS_AbsAngle
  extends XcosCoselica.Mechanics.Planar.Sensors.AbsAngle;
end CMPS_AbsAngle;

model CMPS_AbsAngularVelocity
  extends XcosCoselica.Mechanics.Planar.Sensors.AbsAngularVelocity;
end CMPS_AbsAngularVelocity;

model CMPS_AbsAngularAccelerat
  extends XcosCoselica.Mechanics.Planar.Sensors.AbsAngularAcceleration;
end CMPS_AbsAngularAccelerat;

model CMPS_Power
  extends XcosCoselica.Mechanics.Planar.Sensors.Power;
end CMPS_Power;

model CMPF_WorldForce
  extends XcosCoselica.Mechanics.Planar.Forces.WorldForce;
end CMPF_WorldForce;

model CMPF_WorldTorque
  extends XcosCoselica.Mechanics.Planar.Forces.WorldTorque;
end CMPF_WorldTorque;

model CMPF_FrameForce
  extends XcosCoselica.Mechanics.Planar.Forces.FrameForce;
end CMPF_FrameForce;

model CMPF_LineForce
  extends XcosCoselica.Mechanics.Planar.Forces.LineForce;
end CMPF_LineForce;

model MTH_HeatCapacitor
  extends XcosModelica.Thermal.HeatTransfer.HeatCapacitor;
end MTH_HeatCapacitor;

model MTH_ThermalConductor
  extends XcosModelica.Thermal.HeatTransfer.ThermalConductor;
end MTH_ThermalConductor;

model MTH_BodyRadiation
  extends XcosModelica.Thermal.HeatTransfer.BodyRadiation;
end MTH_BodyRadiation;

model MTH_Convection
  extends XcosModelica.Thermal.HeatTransfer.Convection;
end MTH_Convection;

model MTH_FixedTemperature
  extends XcosModelica.Thermal.HeatTransfer.FixedTemperature;
end MTH_FixedTemperature;

model MTHC_FixedTemperature
  extends XcosModelica.Thermal.HeatTransfer.Celsius.FixedTemperature;
end MTHC_FixedTemperature;

model MTH_FixedHeatFlow
  extends XcosModelica.Thermal.HeatTransfer.FixedHeatFlow;
end MTH_FixedHeatFlow;

model MTH_PrescribedTemperatur
  extends XcosModelica.Thermal.HeatTransfer.PrescribedTemperature;
end MTH_PrescribedTemperatur;

model MTHC_PrescribedTemperatu
  extends XcosModelica.Thermal.HeatTransfer.Celsius.PrescribedTemperature;
end MTHC_PrescribedTemperatu;

model MTH_PrescribedHeatFlow
  extends XcosModelica.Thermal.HeatTransfer.PrescribedHeatFlow;
end MTH_PrescribedHeatFlow;

model MTH_TemperatureSensor
  extends XcosModelica.Thermal.HeatTransfer.TemperatureSensor;
end MTH_TemperatureSensor;

model MTHC_TemperatureSensor
  extends XcosModelica.Thermal.HeatTransfer.Celsius.TemperatureSensor;
end MTHC_TemperatureSensor;

model MTH_HeatFlowSensor
  extends XcosModelica.Thermal.HeatTransfer.HeatFlowSensor;
end MTH_HeatFlowSensor;

model MTH_RelTemperatureSensor
  extends XcosModelica.Thermal.HeatTransfer.RelTemperatureSensor;
end MTH_RelTemperatureSensor;

model MTHC_ToKelvin
  extends XcosModelica.Thermal.HeatTransfer.Celsius.ToKelvin;
end MTHC_ToKelvin;

model MTHC_FromKelvin
  extends XcosModelica.Thermal.HeatTransfer.Celsius.FromKelvin;
end MTHC_FromKelvin;
