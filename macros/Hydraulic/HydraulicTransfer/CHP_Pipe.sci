...
//    [x,y]=standard_origin(arg1);
  case 'set' then
    ...
    while %t do
      [ok,L,D,C,exprs]=...
        getvalue(['';'CHP_Pipe';'';'Pipe with hydraulic resistor from the Hazen-William friction loss equation';''],...
        [' L [ft] : Pipe length';' D [in] : Pipe diameter';' C [-] : Hazen-William coefficient'],...
