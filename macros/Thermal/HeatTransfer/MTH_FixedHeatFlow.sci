  ...
  case 'set' then
    ...
    while %t do
      [ok,Q_flow,T_ref,alpha,exprs]=...
        getvalue(['';'MTH_FixedHeatFlow';'';'Fixed heat flow boundary condition';''],...
        [' Q_flow [W] : Fixed heat flow rate at port';' T_ref [K] : Reference temperature';' alpha [1/K] : Temperature coefficient of heat flow rate'],...
