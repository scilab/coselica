...
select job
  ...
  case 'define' then
    ...
    gr_i=[
          ...
          'e.line_style=1;';
          'if orient then';
          '  xstringb(orig(1)+sz(1)*-0.1,orig(2)+sz(2)*0.68,""""+string(v_fixed)+"""",sz(1)*1.22,sz(2)*0.12,""fill"");';
          'else';
          '  xstringb(orig(1)+sz(1)*(1--0.1-1.22),orig(2)+sz(2)*0.68,""""+string(v_fixed)+"""",sz(1)*1.22,sz(2)*0.12,""fill"");';
          'end';
          'e=gce();';
          'e.visible=""on"";';
          'e.foreground=color(0,0,0);';
