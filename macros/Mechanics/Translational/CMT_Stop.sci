     ...
     case 'set' then
      ...
      while %t do
          [ok,smax,smin,m,F_prop,F_Coulomb,F_Stribeck,fexp,mode_start,L,exprs]=..
              getvalue(['CMT_Stop';__('Sliding mass with hard stop and Stribeck friction')],..
                       [__('smax [m] : right stop for (right end of) sliding mass');...
                        __('smin [m] : left stop for (left end of) sliding mass');...
