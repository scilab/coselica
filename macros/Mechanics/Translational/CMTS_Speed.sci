...
select job
  ...
  case 'define' then
    ...
    gr_i=[
          ...
          'end';
          'if orient then';
          '  xstringb(orig(1)+sz(1)*-0.21,orig(2)+sz(2)*0.1,""v_ref"",sz(1)*0.52,sz(2)*0.16,""fill"");';
          'else';
          '  xstringb(orig(1)+sz(1)*(1--0.21-0.52),orig(2)+sz(2)*0.1,""v_ref"",sz(1)*0.52,sz(2)*0.16,""fill"");';
          'end';
          'e=gce();';
          'e.visible=""on"";';
