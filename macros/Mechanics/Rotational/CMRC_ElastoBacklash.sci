     ...
     case 'set' then
      ...
      while %t do
          [ok,c,d,b,phi_rel0,exprs]=...
              getvalue(['CMRC_ElastoBacklash';__('Backlash connected in series to linear spring and damper (backlash is modeled with elasticity)')],...
                       [__('c [N.m/rad] : Spring constant (c > 0 required)');...
                        __('d [N.m.s/rad] : Damping constant (d >= 0)');...
                        __('b [rad] : Total backlash (b >= 0)');...
