...
select job
  case 'plot' then
    tau_constant=arg1.graphics.exprs(1);
  ...
  case 'define' then
    ...
    gr_i=[
          ...
          'e.thickness=0.25;';
          'e.line_style=1;';
          'xpoly(xx+ww*[0.01;1],yy+hh*[0.5;0.5]);';
          'e=gce();';
          'e.visible=""on"";';
          'e.foreground=color(0,0,255);';
          'e.thickness=0.25;';
          'e.line_style=1;';
          'if orient then';
          '  xstringb(orig(1)+sz(1)*-0.12,orig(2)+sz(2)*0.3,""""+string(tau_constant)+"""",sz(1)*1.22,sz(2)*0.12,""fill"");';
          'else';
          '  xstringb(orig(1)+sz(1)*(1--0.12-1.22),orig(2)+sz(2)*0.3,""""+string(tau_constant)+"""",sz(1)*1.22,sz(2)*0.12,""fill"");';
          'end';
          'e=gce();';
          'e.visible=""on"";';
          'e.foreground=color(0,0,0);';
