...
function [x,y,typ]=CMRS_Position(job,arg1,arg2)
x=[];y=[];typ=[];
select job
  case 'plot' then
  ...
  case 'define' then
    ...
    gr_i=[
          ...
          'e.thickness=0.25;';
          'e.line_style=1;';
          'xpoly(xx+ww*[0.5;0.5],yy+hh*[0.34;0]);';
          'e=gce();';
          'e.visible=""on"";';
          'e.foreground=color(0,0,0);';
          'e.thickness=0.25;';
          ...
          'e.line_style=1;';
          'if orient then';
          '  xstringb(orig(1)+sz(1)*-0.29,orig(2)+sz(2)*0.11,""phi_ref"",sz(1)*0.52,sz(2)*0.17,""fill"");';
          'else';
          '  xstringb(orig(1)+sz(1)*(1--0.29-0.52),orig(2)+sz(2)*0.11,""phi_ref"",sz(1)*0.52,sz(2)*0.17,""fill"");';
          'end';
          'e=gce();';
          'e.visible=""on"";';
          'e.foreground=color(0,0,0);';
    ...
    x.graphics.out_style=['shape=ellipse;strokeColor=#C0C0C0';'shape=ellipse;fillColor=#C0C0C0;strokeColor=#C0C0C0'];
  end
endfunction
