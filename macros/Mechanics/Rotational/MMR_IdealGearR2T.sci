...
function [x,y,typ]=MMR_IdealGearR2T(job,arg1,arg2)
    ...
    select job
     case 'set' then
      ...
      while %t do
          [ok,ratio,exprs]=...
              getvalue(['MMR_IdealGearR2T';__('Gearbox transforming rotational into translational motion')],...
     ...
     case 'define' then
      ...
      x.graphics.in_style=[TransInputStyle(), RotInputStyle()];
      x.graphics.out_implicit=['I','I'];
      x.graphics.out_style=[TransOutputStyle(), RotOutputStyle()];
    end
endfunction
