...
select job
  ...
  case 'define' then
    ...
    w_start=0;
    z_start=0;
    model.sim='CMPJ_ActuatedRevolute';
    model.blocktype='c';
    model.dep_ut=[%t %f];
    mo=modelica();
      mo.model='CMPJ_ActuatedRevolute';
    ...
    exprs=[sci2exp(phi_offset);sci2exp(initType);sci2exp(phi_start);sci2exp(w_start);sci2exp(z_start)];
    gr_i=[...
          'if orient then';...
          '  xx=orig(1);yy=orig(2);';...
          '  ww=sz(1);hh=sz(2);';...
