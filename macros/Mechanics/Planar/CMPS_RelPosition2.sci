...
function [x,y,typ]=CMPS_RelPosition2(job,arg1,arg2)
x=[];y=[];typ=[];
select job
  case 'plot' then
  ...
  case 'define' then
    ...
    model.out=[1;2];
    mo=modelica();
      mo.model='Coselica.Mechanics.Planar.Sensors.RelPosition2';
    ...
    gr_i=[
          ...
          'e.line_style=1;';
          'if orient then';
          '  xstringb(orig(1)+sz(1)*0.6,orig(2)+sz(2)*0,""r_rel"",sz(1)*0.7,sz(2)*0.15,""fill"");';
          'else';
          '  xstringb(orig(1)+sz(1)*(1-0.6-0.7),orig(2)+sz(2)*0,""r_rel"",sz(1)*0.7,sz(2)*0.15,""fill"");';
          'end';
          'e=gce();';
          'e.visible=""on"";';
          'e.foreground=color(0,0,0);';
    ...
    x.graphics.in_style=['fillColor=blue;strokeColor=blue','fillColor=blue;strokeColor=blue'];
    x.graphics.out_style=['fillColor=white;strokeColor=blue','fillColor=white;strokeColor=blue'];
  end
endfunction
