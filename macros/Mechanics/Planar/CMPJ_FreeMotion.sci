  ...
  case 'set' then
    ...
    while %t do
      [ok,initType,r_rel_a_start,v_rel_a_start,a_rel_a_start,phi_rel_start,w_rel_start,z_rel_start,exprs]=..
        ...
        [' initType [-] : Type of initial value for [r_rel_a,v_rel_a,a_rel_a,phi_rel,w_rel,z_rel] (0=guess,1=fixed)';' r_rel_a_start [m] : Initial values of r_rel_a (vector from origin of frame_a to origin of frame_b resolved in frame_a)';' v_rel_a_start [m/s] : Initial values of velocity v_rel_a = der(r_rel_a)',' a_rel_a_start [m/s2] : Initial values of acceleration a_rel_a = der(v_rel_a)',' phi_rel_start [rad] : Initial value of angle phi_rel to rotate frame_a into frame_b',' w_rel_start [rad/s] : Initial value of angular velocity w_rel = der(phi_rel) of frame_b with respect to frame_a',' z_rel_start [rad/s2] : Initial value of angular acceleration z_rel = der(w_rel) of frame_b with respect to frame_a'],..
