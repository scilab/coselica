     ...
     case 'set' then
      ...
      while %t do
          [ok,Ron,Goff,V0,dVdt,Vmax,exprs]=...
              getvalue(['';'MEAI_CloserWithArc';'';'Ideal closing switch with simple arc model';''],...
                       [' Ron [Ohm] : Closed switch resistance';' Goff [S] : Opened switch conductance';' V0 [V] : Initial arc voltage';' dV/dt [V/s] : Arc voltage slope';' Vmax [V] : Max. arc voltage'],...
