     ...
     case 'set' then
      ...
      while %t do
          [ok,Ron,Goff,Vknee,exprs]=...
              getvalue(['CEAI_IdealDiode';__('Ideal diode')],...
                       [__('Ron [Ohm] : Forward state-on differential resistance (closed diode resistance >=0)');...
                        __('Goff [S] : Backward state-off conductance (opened diode conductance >= 0)');...
                        __('Vknee [V] : Forward threshold voltage (>= 0)')],...
