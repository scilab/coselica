     ...
     case 'set' then
      ...
      while %t do
          [ok,Ids,Maxexp,R,EG,N,TNOM,XTI,exprs]=...
              getvalue(['';'MEAS_HeatingDiode';'';'Simple diode with heating port';''],...
                       [' Ids [A] : Saturation current';' Maxexp [-] : Max. exponent for linear continuation';' R [Ohm] : Parallel ohmic resistance'; 'EG : activation energy';' N : Emission coefficient';' TNOM (K) : Parameter measurement temperature';' XTI : Temperature exponent of saturation current'],...
