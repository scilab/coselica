...
select job
  ...
  case 'define' then
    ...
    x.graphics.in_style=["fillColor=blue;strokeColor=blue";"shape=ellipse;fillColor=#666666;strokeColor=#666666"]
    x.graphics.out_implicit=['I','I'];
    x.graphics.out_style=["strokeColor=blue";"shape=ellipse;strokeColor=#999999"]
  end
endfunction
