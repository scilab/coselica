     ...
     case 'set' then
      ...
      while %t do
          [ok,I,rising,width,falling,period,nperiod,offset,startTime,exprs]=...
              getvalue(['CEAS_TrapezoidCurrent';__('Trapezoidal current source')],...
                       [__('I [A] : Amplitude of trapezoid');...
                        __('rising [s] : Rising duration of trapezoid (>=0)');...
                        __('width [s] : Width duration of trapezoid (>=0)');...
                        __('falling [s] : Falling duration of trapezoid (>=0)');...
                        __('period [s] : Time for one period (>0)');...
