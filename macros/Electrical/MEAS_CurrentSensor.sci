...
select job
  ...
  case 'define' then
    ...
    gr_i=[...
          ...
          'e.line_style=1;';...
          'if orient then';...
          '  xstringb(orig(1)+sz(1)*0.355,orig(2)+sz(2)*0.15,""A"",sz(1)*0.295,sz(2)*0.295,""fill"");';...
          'else';...
          '  xstringb(orig(1)+sz(1)*(1-0.355-0.295),orig(2)+sz(2)*0.15,""A"",sz(1)*0.295,sz(2)*0.295,""fill"");';...
          'end';...
          'e=gce();';...
          'e.visible=""on"";';...
          'e.foreground=color(0,0,0);';...
          ...
          'e.thickness=0.25;';...
          'e.line_style=1;';...
          'xpoly(xx+ww*[0.5;0.5],yy+hh*[0.05;0.15]);';...
          'e=gce();';...
          'e.visible=""on"";';...
    ...
    x.graphics.out_style=["strokeColor=blue";"shape=triangle;fillColor=blue;strokeColor=blue"]
  end
endfunction
