      ...
      while %t do
          [ok,Lrsigmad,Lrsigmaq,Rrd,Rrq,exprs]=...
              getvalue(['';'MEMC_DamperCage';'';'Damper Cage';''],...
                       [' Lrsigmad (H): tray inductance in d-axis per phase translated to stator';' Lrsigmaq (H): tray inductance in q-axis per phase translated to stator';' Rrd (Ohm): warm resistance in d-axis per phase translated to stator';' Rrq (Ohm): warm resistance in q-axis per phase translated to stator'],...
